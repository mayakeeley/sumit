...
if IN_DEV:
    SERVER_EMAIL = "Sumit Development <noreply-dev@sumit.com>"
elif IN_STAGING:
    SERVER_EMAIL = "Sumit Staging <noreply-staging@sumit.com>"
else:
    SERVER_EMAIL = "Sumit <noreply@sumit.com>"
...
#
HEROKU_APP_NAME = config("HEROKU_APP_NAME", default="sumit-staging")
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, "sumit", "client", "templates"),  # Swagger template override
        ],
        "OPTIONS": {
            "context_processors": [
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "sumit.core.pagination.PageNumberPagination",
...
if config("USE_AWS_STORAGE", cast=bool, default=False) and not IS_REVIEW_APP:
    ...
    DEFAULT_FILE_STORAGE = "sumit.utils.storages.PrivateMediaStorage"
    # STATICFILES_STORAGE = "sumit.utils.storages.StaticRootS3Boto3Storage"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "sumit.request": {"handlers": [], "level": "INFO", "propagate": True},
        "sumit.tasks": {"handlers": [], "level": "INFO", "propagate": True},
    },
}
...
if IN_PROD or ROLLBAR_ACCESS_TOKEN:
    ...
    LOGGING["loggers"]["sumit"]["handlers"].append("rollbar")

# Popular testing framework that allows logging to stdout while running unit tests
TEST_RUNNER = "django_nose.NoseTestSuiteRunner"

CORS_ALLOWED_ORIGINS = ["https://sumit-staging.herokuapp.com", "https://sumit.herokuapp.com"]
